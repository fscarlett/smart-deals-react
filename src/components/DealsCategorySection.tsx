    ...
    <section className='w-full max-w-[1600px] mx-auto mb-8'>
      <div className='h-full overflow-x-auto'>
        <div className='w-full'>
          ...
          <div className='w-full h-[200px] bg-teal-100 flex items-center justify-center'>
            <span className='text-gray-500'>
              Category slider goes here, dynamic 3 cards, arrows scroll 3 cards
              at a time, 10 + deep
            </span>
          </div>
        </div>
...
export default DealsCategorySection
